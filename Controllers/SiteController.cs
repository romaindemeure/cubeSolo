...
using System.Data;
using newCubeBackend.SiteModel;

// Définition du nom de l'espace via (namespace).
namespace newCubeBackend.SiteController
{
    ...
    public class SiteController : ControllerBase
    {
        ...
        public String Get()
        {
            ...
            string query = "SELECT * FROM tableSite";
        ...
        {
            string query = "SELECT * FROM tableSite WHERE IdVille = @Id";
        ...
        public JsonResult Post(Site site)
        {
            ...
            string query = @"INSERT INTO tableSite(ville) 
                            VALUES (@Ville)";
        ...
        {
            string query = @"delete from tableSite where IdVille = @Id;";
