...
namespace newCubeBackend.UtilisateurController
{
    ...
    public class UtilisateurController : ControllerBase
    {
        ...
        public JsonResult Post(User user)
        {
            ...
            string query = @"INSERT INTO tableUtilisateur(prenomUtilisateur, nomUtilisateur, emailUtilisateur, motDePasseUtilisateur, telephoneFixUtilisateur, telephonePortableUtilisateur, service, site, administrateur) 
                            VALUES (@Prenom, @Nom, @Email, @Mot_de_passe, @Telephone_Fix_Utilisateur, @Telephone_Portable_Utilisateur, @Service, @Site, @Admin)";
            ...
            cmd.Parameters.AddWithValue("@Telephone_Fix_Utilisateur", user.Telephone_Fix_Utilisateur);
            cmd.Parameters.AddWithValue("@Telephone_Portable_Utilisateur", user.Telephone_Portable_Utilisateur);
        ...
        public JsonResult Put(int id, User user)
        {
            var sql = @"UPDATE tableUtilisateur
                        ...
                        telephoneFixUtilisateur = @Telephone_Fix_Utilisateur, 
                        telephonePortableUtilisateur = @Telephone_Portable_Utilisateur, 
                        service = @Service,
                        site = @Site
